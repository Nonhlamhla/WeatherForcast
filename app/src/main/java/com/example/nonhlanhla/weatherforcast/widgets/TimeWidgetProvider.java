package com.example.nonhlanhla.weatherforcast.widgets;
...
import com.example.nonhlanhla.weatherforcast.BuildConfig;
import com.example.nonhlanhla.weatherforcast.activities.MainActivity;
...
public class TimeWidgetProvider extends AbstractWidgetProvider {
    ...
    private static final String ACTION_UPDATE_TIME = "com.example.nonhlanhla.weatherforcast.UPDATE_TIME";
